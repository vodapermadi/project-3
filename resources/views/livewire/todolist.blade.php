        ...
        <div class="card-body">
            ...
            <form wire:submit.prevent='simpan'>
                ...
                <div class="form-group">
                    ...
                    <input type="text" wire:model='rencana_kegiatan' class="form-control" placeholder="Kegiatan">
                </div>
                <br>
                <!-- Select -->
                <div class="form-group">
                    ...
                    @foreach ($todos as $row)
                        <tr>
                            ...
                            <td>
                                ...
                                @if ($row->status)
                                    <button wire:click='hapus({{ $row->id }})' class="btn btn-danger">Hapus</button>
                                @else
                                    <button wire:click='ubahStatus({{ $row->id }})' class="btn btn-success">Clear</button>
                                @endif
                            </td>
                        </tr>
                    @endforeach
